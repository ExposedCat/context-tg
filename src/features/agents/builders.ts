...
export function buildRespondingInstructions(
  ...
  return [
    ...
    "- Image tools return persistent image IDs and ready-to-use Markdown. Insert a saved image with `![](tg://photo?id=IMAGE_ID)`, using the exact returned ID. You may place, reorder, repeat, or reuse saved images in later responses; never invent or alter an image ID.",
